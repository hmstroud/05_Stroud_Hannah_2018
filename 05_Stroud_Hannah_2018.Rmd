...
chisq.test(extinct$Frequency, p= frequency)
```
...
#### 2.1 Ch11 Q21
```{r}
read_csv("./data/chap11q21SoilLeadAndHurricanes.csv")
```
...
```{r}
get_t_power <- function(m1, m2, s1,s2, n1,n2, nsims = 100, alpha = 0.05){
...
get_t_power_var <- function(m1, m2, s1,s2, n1,n2, nsims = 50, alpha = 0.05){
  #first, p values vector
  p <- replicate(nsims,
